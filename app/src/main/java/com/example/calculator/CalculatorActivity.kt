...
class CalculatorActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // IMPORTANTE: ahora usamos el binding del layout activity_calculator.xml
        ...
        binding.btnCalcular.setOnClickListener {
            ...
            // OJO: tu Activity de resultados se llama ResultsActivity (con 's')
    ...
    private fun validarEntradas(): Boolean {
        ...
        if (s1.isEmpty()) {
            binding.input1.error = "Ingresa un número"; ok = false
        } else if (n1 == null) {
            binding.input1.error = "Formato inválido (usa punto decimal)"; ok = false
        }

        if (s2.isEmpty()) {
            binding.input2.error = "Ingresa un número"; ok = false
        } else if (n2 == null) {
            binding.input2.error = "Formato inválido (usa punto decimal)"; ok = false
        }
